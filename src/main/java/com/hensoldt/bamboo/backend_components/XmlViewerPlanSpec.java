...
@BambooSpec
public class XmlViewerPlanSpec {
    
    public Plan plan() {
        return new Plan(new Project()
                .oid(new BambooOid("1ophrz71tqlfl"))
                .key(new BambooKey("JOH"))
                .name("JohanSandpit"),
            "xml-viewer",
            new BambooKey("XMLVIEW"))
            .oid(new BambooOid("1op82rlolwt1g"))
                    ...
                    .jobs(new Job("Default Job",
                            ...
                            .tasks(new VcsCheckoutTask()
                                ...
                                new MavenTask()
                                    ...
                                    .workingSubdirectory("xml-viewer"),
                                new MavenTask()
            ...
            .linkedRepositories("xml-viewer")
            .planRepositories(new BitbucketServerRepository()
                    .name("bamboo-config-files")
                    .oid(new BambooOid("1opc8ffeueps6"))
    ...
    public PlanPermissions planPermission() {
        return new PlanPermissions(new PlanIdentifier("JOH", "XMLVIEW"))
